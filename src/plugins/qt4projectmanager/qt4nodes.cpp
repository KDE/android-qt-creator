...
QStringList Qt4ProFileNode::includePaths(QtSupport::ProFileReader *reader) const
{
    ...
    paths << m_readerExact->values(QLatin1String("QMAKE_INCDIR"))
          << m_readerExact->values(QLatin1String("QMAKE_INCDIR_X11"))
          << m_readerExact->values(QLatin1String("QMAKE_INCDIR_QT"))
          << m_readerExact->values(QLatin1String("QMAKE_INCDIR_OPENGL"))
          << m_readerExact->values(QLatin1String("QMAKE_INCDIR_OPENGL_ES1"))
          << m_readerExact->values(QLatin1String("QMAKE_INCDIR_EGL"))
          << m_readerExact->values(QLatin1String("QMAKE_INCDIR_OPENVG"));
