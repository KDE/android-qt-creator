...
class AndroidDeviceEnvReader : public QObject
{
    Q_OBJECT
public:
    AndroidDeviceEnvReader(QObject *parent, AndroidRunConfiguration *config);
    ~AndroidDeviceEnvReader();
