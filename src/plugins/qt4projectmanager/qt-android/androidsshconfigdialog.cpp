...
AndroidSshConfigDialog::AndroidSshConfigDialog(QWidget *parent)
    : QDialog(parent)
...
AndroidSshConfigDialog::~AndroidSshConfigDialog()
{
}

void AndroidSshConfigDialog::slotToggled()
{
    m_ui.comboBox->setCurrentIndex(0);
    m_ui.comboBox->setEnabled(m_ui.rsa->isChecked());
}

void AndroidSshConfigDialog::generateSshKey()
{
...
void AndroidSshConfigDialog::savePublicKey()
{
    saveKey(true);
}

void AndroidSshConfigDialog::savePrivateKey()
{
    saveKey(false);
}

void AndroidSshConfigDialog::checkSshDir()
{
...
void AndroidSshConfigDialog::saveKey(bool publicKey)
{
    checkSshDir();
