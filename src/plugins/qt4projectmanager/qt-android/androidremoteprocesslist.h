...
#ifndef ANDROIDREMOTEPROCESSLIST_H
#define ANDROIDREMOTEPROCESSLIST_H
...
class AndroidRemoteProcessList : public QAbstractTableModel
{
    Q_OBJECT
public:
    explicit AndroidRemoteProcessList(const Core::SshConnectionParameters &params,
        QObject *parent = 0);
    ~AndroidRemoteProcessList();
    void update();
...
#endif // ANDROIDREMOTEPROCESSLIST_H
